  ...
  const events = useMemo(() => {
    return medications
      ...
      .map(med => {
        ...
        const startDate = new Date(depletionDate);

        // FullCalendar treats all-day event ends as exclusive. Adding one day
        // keeps the medication visible through its calculated depletion date.
        ...
        return {
          ...
          extendedProps: {
            ...
            depletionDate: localDateString(depletionDate)
          }
        };
      });
  }, [medications]);
      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-gray-600">
            Prognose, wann deine aktuellen Medikamentenbestände voraussichtlich aufgebraucht sind
          </p>
        </div>
            ...
            eventContent={(arg) => {
              ...
              return (
                <div className="fc-event-main-frame" style={{ padding: isMobile ? '1px 3px' : '2px 4px' }}>
                  ...
                  >
                    {isListView ? `Voraussichtlich leer in ${Math.max(0, Math.round(daysRemaining))} Tagen` : 'Voraussichtlich leer'}
                  </div>
                </div>
              );
            }}
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          <div className="rounded-lg bg-red-50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-700">Unter deiner Warngrenze</p>
              </div>
            </div>
          </div>
          <div className="rounded-lg bg-amber-50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">Weniger als 14 Tage</p>
              </div>
            </div>
          </div>
          <div className="rounded-lg bg-green-50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-green-900">Stabil</p>
                <p className="text-sm text-green-700">Mindestens 14 Tage</p>
              </div>
            </div>
          </div>
        </div>
