function Button({ children, variant = 'primary', className = '', ...props }) {
  const base =
    'min-h-11 px-4 py-2 rounded-lg font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition disabled:cursor-not-allowed disabled:opacity-60';
  const variants = {
